...
public class VisorPantallaElimi extends javax.swing.JFrame {

    /**
     * Creates new form EliminarVisor
     */
    public VisorPantallaElimi() {
        initComponents();
    ...
    private void insertarBotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertarBotActionPerformed
        ...
        if(PrincipalAtletismo.claseMain.deleteVisorAtleta(idVisor) != null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisorPantallaElimi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisorPantallaElimi().setVisible(true);
            }
        });
    }
