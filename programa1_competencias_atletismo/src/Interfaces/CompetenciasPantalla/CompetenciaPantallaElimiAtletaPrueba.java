...
public class CompetenciaPantallaElimiAtletaPrueba extends javax.swing.JFrame {

    /**
     * Creates new form CompetenciaPantallaElimiAtletaPrueba
     */
    public CompetenciaPantallaElimiAtletaPrueba() {
        initComponents();
    ...
    private void insertarBotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertarBotActionPerformed
        ...
        //JOptionPane.showMessageDialog(null, "Se ha eliminado correctamente"); //se realiza bien
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompetenciaPantallaElimiAtletaPrueba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompetenciaPantallaElimiAtletaPrueba().setVisible(true);
            }
        });
    }
